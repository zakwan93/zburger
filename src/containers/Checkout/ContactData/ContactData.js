...
class ContactData extends Component {
  ...
  inputChangedHandller = (event, inputIdentifier) => {
    ...
    for (let fromIdentifier in updatedOrderForm) {
      formIsValid = updatedOrderForm[fromIdentifier].valid && formIsValid;
    }
      ...
      <form onSubmit={this.orderHandler}>
        {formElementArray.map(formElement => (
          <Input
            ...
            changed={event => this.inputChangedHandller(event, formElement.id)}
          />
        ))}
        <Button
          btnType="Success"
